    ...
    private void judgeValue(){
        ...
        try {
            if (ans.equals("本人")){
                ...
                heartRate.set(count% totalY -1,ValueHR);
                PI.set(count% totalY -1,ValuePI);
                CVI.set(count% totalY -1,ValueCvi);
                C1a.set(count% totalY -1,ValueC1a);
            }else{
                newDialog();
            }
        }catch (Exception e){
